...
public class AdminAddNewProductActivity extends AppCompatActivity
{
        ...
        InputProductImage.setOnClickListener(new View.OnClickListener() {
           ...
           AddNewProductButton.setOnClickListener(new View.OnClickListener() {
               ...
               private void ValidateProductData()
               {
                   ...
                   {
                       StorePruductInformation();
                   }
               }

               private void StorePruductInformation()
               {
                   ...
                   //Storage reference and the firebase product random key
                       ...
                       public void onSuccess(UploadTask.TaskSnapshot taskSnapshot)
                       {
                          ...
                          Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                              ...
                              public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task) throws Exception
                              {
                                  ...
                                  downloadImageUrl = filePath.getDownloadUrl().toString();   //Firebase theke image uri ta nicchi
    ...
    @Override
        protected void onActivityResult(int requestCode, int resultCode, Intent data)
        {
            ...
            // Choose image from gallery and image url code
